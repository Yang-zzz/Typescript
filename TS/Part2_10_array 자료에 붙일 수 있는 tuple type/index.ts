...
let testArr = [1, 2, 3];
let testArr2: [number, number, ...number[]] = [4, 5, ...testArr]; // spread연산자를 사용할 때, 타입지정
...
type 테스트파라 = [string, boolean, number | string];
function 함수수(...x: 테스트파라) {}
...
// type 분류함수파라 = [...(string | number)[]];

// type 분류함수리턴 = [];
// function 분류함수(...x: 분류함수파라) {
//     let result:
// };
